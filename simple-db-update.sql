-- =====================================================
-- SIMPLE DATABASE UPDATE SCRIPT (NO ERRORS)
-- =====================================================
...
-- 12. Add indexes for students table (skip if table doesn't exist)
CREATE INDEX IF NOT EXISTS idx_students_department_section ON students(department, section);

-- 13. Skip quiz_results index for now (column names unclear)
-- CREATE INDEX IF NOT EXISTS idx_quiz_results_student_quiz ON quiz_results(studentid, quiz_id);
-- Uncomment above line only after confirming the correct column names in quiz_results table
